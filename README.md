...
| `MINIO_ENDPOINT` | não | Host de uma instância do [MinIO](https://min.io/) (self-hosted, compatível com S3, grátis, sem custo por uso — task-008), usada pra guardar foto de perfil profissional. Sem ela, as fotos continuam sendo salvas em disco local (`uploads/`), como sempre foi. |
