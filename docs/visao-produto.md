...
- **Pesquisa de custo real (2026-09-11), pra decidir com número na mão em vez de chutar:**
  - **Photoroom API** — parece a opção mais madura pro caso de uso ("deixar foto de produto/perfil com cara profissional"): ~US$0,02/foto só remoção de fundo, ~US$0,10/foto com fundo e sombra gerados por IA (a versão que realmente "melhora" a foto). Em volume pequeno (ex: 50 fotos novas/mês no começo) fica em torno de US$1 a US$5/mês (~R$5 a R$28/mês) — cabe dentro do teto atual de R$50/mês com folga, mesmo sem aumentar o orçamento.
  - **Cloudinary** — tem tier grátis generoso (25 mil transformações/mês grátis), mas os efeitos de "AI enhance"/fundo por IA de verdade costumam ficar no plano pago; precisa confirmar exatamente quais efeitos entram no grátis antes de contar com ele pra essa parte.
  - **Replicate/fal.ai** (modelos avulsos tipo upscale/restauração de foto) — cobram por inferência, também na faixa de US$0,01 a US$0,10 por imagem, dependendo do modelo escolhido.
  - **Recomendação, aguardando confirmação da Jéssica:** Photoroom parece a melhor relação custo/resultado pro que foi descrito (foto de prestador com cara mais profissional) e cabe no orçamento atual em volume inicial — mas a decisão final (qual serviço, e se aumenta o teto de R$50/mês se o volume crescer) é dela.
